...
static const keymap_t keys[] = {
	...
	{ 0          ,  XK_Pointer_Left,  g_reorder_image,      -1 },
	{ 0          ,  XK_Pointer_Left,  t_move_sel,           DIR_LEFT },
	{ 0          ,  XK_Pointer_Right, g_reorder_image,      +1 },
	{ 0          ,  XK_Pointer_Right, t_move_sel,           DIR_RIGHT },
	{ 0          ,  XK_Pointer_Up,    g_reorder_image,      -16 },
	{ 0          ,  XK_Pointer_Up,    t_move_sel,           DIR_UP },
	{ 0          ,  XK_Pointer_Down,  g_reorder_image,      +16 },
	{ 0          ,  XK_Pointer_Down,  t_move_sel,           DIR_DOWN },
